    ...
    <div className={styles.container}>
        ...
        <div className={styles.boxWrapper}>
            <div className={styles.whiteBox}>
              <h2 className='gcal-header'>Add our GCAL <a href="https://calendar.google.com/calendar/embed?src=cs124honors%40gmail.com&ctz=America%2FChicago" target="_blank">here</a></h2>
